...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    ALLILEAF,        SET_UP_DOLL,       EVENT_DECO_ALLILEAF_DOLL,           SPRITE_ALLILEAF
	decoration DECO_DOLL,    LAVASAUR,        SET_UP_DOLL,       EVENT_DECO_LAVASAUR_DOLL,           SPRITE_LAVASAUR
	decoration DECO_DOLL,    SHARQUA,         SET_UP_DOLL,       EVENT_DECO_SHARQUA_DOLL,            SPRITE_SHARQUA
	...
	decoration DECO_DOLL,    BUGGY,           SET_UP_DOLL,       EVENT_DECO_BUGGY_DOLL,              SPRITE_BUGGY
