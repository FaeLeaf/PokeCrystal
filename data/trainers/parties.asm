...
FalknerGroup:
	...
	db  7, PEBBIRD,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
...
BugsyGroup:
	...
	db 14, BUGGY,    TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 14, BUGGY,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
...
ChampionGroup:
	...
	db 46, VOLBRACHIO,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
...
YoungsterGroup:
	...
	db 21, CAPYBOARA,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, CAPYBOARA,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, CAPYBOARA,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 26, LAVASAUR, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db 26, SHARQUA,   WITHDRAW, WATER_GUN, BITE, CURSE
	db 26, ALLILEAF,  LEECH_SEED, POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
	...
	db 27, BRONTOSEAR, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 32, SLASHARK,  BITE, CURSE, SURF, RAIN_DANCE
	db -1 ; end
	...
	db 32, ALLILEAF,  GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, CROCOFROND,    GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, DRACODILE,   BODY_SLAM, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
	...
	db 25, BUGGY, CONFUSION, SLEEP_POWDER, WHIRLWIND, GUST
...
BugCatcherGroup:
	...
	db 24, BUGGY, CONFUSION, POISONPOWDER, SUPERSONIC, WHIRLWIND
	db 24, BUGGY, CONFUSION, STUN_SPORE, SUPERSONIC, WHIRLWIND
	db 25, BUGGY,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 24, BUGGY, CONFUSION, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 30, BUGGY, CONFUSION, POISONPOWDER, SUPERSONIC, GUST
	db 30, BUGGY, CONFUSION, STUN_SPORE, SUPERSONIC, GUST
	db 32, BUGGY,   FURY_ATTACK, PURSUIT, TWINEEDLE, DOUBLE_TEAM
	db 34, BUGGY, PSYBEAM, SLEEP_POWDER, GUST, WHIRLWIND
	db -1 ; end
...
PicnickerGroup:
	...
	db 38, DRACODILE,   SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 32, BUNIWOLP,      WRAP, POISON_STING, BITE, GLARE
	...
	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 23, BUNIWOLP,      WRAP, LEER, POISON_STING, BITE
...
PokefanMGroup:
	...
	db 29, ALLILEAF,  BERRY
	db 29, LAVASAUR, BERRY
	db 29, SHARQUA,   BERRY
	db -1 ; end
...
RedGroup:
	...
	db 77, DRACODILE,   SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLARBEAM
	db 77, VOLBRACHIO,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	db 77, SLASHARK,  RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db -1 ; end
...
GruntFGroup:
	...
	db 18, BUNILOPE,      WRAP, LEER, POISON_STING, BITE
