...
MonMenuIcons:
	...
	db ICON_ALLILEAF    ; ALLILEAF
	db ICON_CROCOFROND  ; CROCOFROND
	db ICON_DRACODILE   ; DRACODILE
	db ICON_LAVASAUR    ; LAVASAUR
	db ICON_BRONTOSEAR  ; BRONTOSEAR
	db ICON_VOLBRACHIO  ; VOLBRACHIO
	db ICON_SHARQUA     ; SHARQUA
	db ICON_SHARQUA     ; THRESHARP
	db ICON_SHARQUA     ; SLASHARK
	db ICON_CAPPI       ; CAPPI
	db ICON_CAPYBOARA   ; CAPYBOARA
	db ICON_PEBBIRD     ; PEBBIRD
	db ICON_FEATHORE    ; FEATHORE
	db ICON_BOULDEROC   ; BOULDEROC
	db ICON_BUGGY       ; BUGGY
	db ICON_PEBBIRD     ; PIDGEY
	db ICON_PEBBIRD     ; PIDGEOTTO
	db ICON_PEBBIRD     ; PIDGEOT
	db ICON_FOX         ; RATTATA
	db ICON_VAPORET     ; VARPOET
	db ICON_FERRESTORM  ; FERRESTORM
	db ICON_BUNILOPE    ; BUNILOPE
	db ICON_BUNIWOLP    ; BUNIWOLP
	...
	db ICON_CAPPI       ; PONYTA
	db ICON_CAPPI       ; RAPIDASH
	db ICON_SLOWPOKE    ; SLOWPOKE
	db ICON_SLOWPOKE    ; SLOWBRO
	db ICON_VOLTORB     ; MAGNEMITE
	db ICON_VOLTORB     ; MAGNETON
	db ICON_PEBBIRD     ; FARFETCH_D
	db ICON_PEBBIRD     ; DODUO
	db ICON_PEBBIRD     ; DODRIO
	db ICON_LAPRAS      ; SEEL
	...
	db ICON_PEBBIRD     ; AERODACTYL
	db ICON_SNORLAX     ; SNORLAX
	db ICON_PEBBIRD     ; ARTICUNO
	db ICON_PEBBIRD     ; ZAPDOS
	db ICON_PEBBIRD     ; MOLTRES
	...
	db ICON_FOX         ; SENTRET
	db ICON_FOX         ; FURRET
	db ICON_PEBBIRD     ; HOOTHOOT
	db ICON_PEBBIRD     ; NOCTOWL
	db ICON_BUG         ; LEDYBA
	db ICON_BUG         ; LEDIAN
	...
	db ICON_PEBBIRD     ; TOGETIC
	db ICON_PEBBIRD     ; NATU
	db ICON_PEBBIRD     ; XATU
	db ICON_FOX         ; MAREEP
