	...
	const ROUTE34ILEXFORESTGATE_PEBBIRD
...
Route34IlexForestGatePebbirdScript:
	opentext
	writetext Route34IlexForestGatePebbirdText
	cry PEBBIRD
	waitbutton
	closetext
	end
...
Route34IlexForestGatePebbirdText:
	text "PEBBIRD: hoochirp!"
	done
...
Route34IlexForestGate_MapEvents:
	...
	object_event  9,  4, SPRITE_BUTTERFREE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route34IlexForestGatePebbirdScript, -1
