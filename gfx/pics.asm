...
VaporetFrontpic:     INCBIN "gfx/pokemon/vaporet/front.animated.2bpp.lz"
VaporetBackpic:      INCBIN "gfx/pokemon/vaporet/back.2bpp.lz"
...
BunilopeFrontpic:    INCBIN "gfx/pokemon/bunilope/front.animated.2bpp.lz"
BunilopeBackpic:     INCBIN "gfx/pokemon/bunilope/back.2bpp.lz"
BuniwolpFrontpic:    INCBIN "gfx/pokemon/buniwolp/front.animated.2bpp.lz"
BuniwolpBackpic:     INCBIN "gfx/pokemon/buniwolp/back.2bpp.lz"
...
FerrestormFrontpic:  INCBIN "gfx/pokemon/ferrestorm/front.animated.2bpp.lz"
FerrestormBackpic:   INCBIN "gfx/pokemon/ferrestorm/back.2bpp.lz"
...
AllileafFrontpic:    INCBIN "gfx/pokemon/allileaf/front.animated.2bpp.lz"
AllileafBackpic:     INCBIN "gfx/pokemon/allileaf/back.2bpp.lz"
CrocofrondFrontpic:  INCBIN "gfx/pokemon/crocofrond/front.animated.2bpp.lz"
CrocofrondBackpic:   INCBIN "gfx/pokemon/crocofrond/back.2bpp.lz"
DracodileFrontpic:   INCBIN "gfx/pokemon/dracodile/front.animated.2bpp.lz"
DracodileBackpic:    INCBIN "gfx/pokemon/dracodile/back.2bpp.lz"
LavasaurFrontpic:    INCBIN "gfx/pokemon/lavasaur/front.animated.2bpp.lz"
LavasaurBackpic:     INCBIN "gfx/pokemon/lavasaur/back.2bpp.lz"
BrontosearFrontpic:  INCBIN "gfx/pokemon/brontosear/front.animated.2bpp.lz"
BrontosearBackpic:   INCBIN "gfx/pokemon/brontosear/back.2bpp.lz"
VolbrachioFrontpic:  INCBIN "gfx/pokemon/volbrachio/front.animated.2bpp.lz"
VolbrachioBackpic:   INCBIN "gfx/pokemon/volbrachio/back.2bpp.lz"
SharquaFrontpic:     INCBIN "gfx/pokemon/sharqua/front.animated.2bpp.lz"
SharquaBackpic:      INCBIN "gfx/pokemon/sharqua/back.2bpp.lz"
ThresharpFrontpic:   INCBIN "gfx/pokemon/thresharp/front.animated.2bpp.lz"
ThresharpBackpic:    INCBIN "gfx/pokemon/thresharp/back.2bpp.lz"
SlasharkFrontpic:    INCBIN "gfx/pokemon/slashark/front.animated.2bpp.lz"
SlasharkBackpic:     INCBIN "gfx/pokemon/slashark/back.2bpp.lz"
CappiFrontpic:       INCBIN "gfx/pokemon/cappi/front.animated.2bpp.lz"
CappiBackpic:        INCBIN "gfx/pokemon/cappi/back.2bpp.lz"
CapyboaraFrontpic:   INCBIN "gfx/pokemon/capyboara/front.animated.2bpp.lz"
CapyboaraBackpic:    INCBIN "gfx/pokemon/capyboara/back.2bpp.lz"
PebbirdFrontpic:     INCBIN "gfx/pokemon/pebbird/front.animated.2bpp.lz"
PebbirdBackpic:      INCBIN "gfx/pokemon/pebbird/back.2bpp.lz"
FeathoreFrontpic:    INCBIN "gfx/pokemon/feathore/front.animated.2bpp.lz"
FeathoreBackpic:	 INCBIN "gfx/pokemon/feathore/back.2bpp.lz"
BoulderocFrontpic:   INCBIN "gfx/pokemon/boulderoc/front.animated.2bpp.lz"
BoulderocBackpic:    INCBIN "gfx/pokemon/boulderoc/back.2bpp.lz"
BuggyFrontpic:       INCBIN "gfx/pokemon/buggy/front.animated.2bpp.lz"
BuggyBackpic:        INCBIN "gfx/pokemon/buggy/back.2bpp.lz"
